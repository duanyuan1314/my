...
class Common_util_pub {
    ...
    function __construct($appid, $appsecret, $mchid, $key) {
        $this->key = $key;
    }
...
class Wxpay_client_pub extends Common_util_pub {
    ...
    function __construct($appid, $appsecret, $mchid, $key) {
        parent::__construct($appid, $appsecret, $mchid, $key);
        $this->appid = $appid;
        $this->mchid = $mchid;
    }
...
class UnifiedOrder_pub extends Wxpay_client_pub {
    ...
    function createXml() {
        try {
            ...
            }/* elseif($this->parameters["product_id"] == null){
              throw new SDKRuntimeException("缺少统一支付接口必填参数product_id！"."<br>");
              } */
            $this->parameters["appid"] = $this->appid; //公众账号ID
            $this->parameters["mch_id"] = $this->mchid; //商户号
