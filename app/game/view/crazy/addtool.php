<div class="layui-tab-item layui-show">
    ...
    <form class="layui-form layui-form-pane" action="{:url('toolsave')}" id="editForm" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input field-username" name="name" lay-verify="title" autocomplete="off" placeholder="请输入道具名">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input " name="price" lay-verify="title" autocomplete="off" placeholder="请输入价格">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">备&nbsp;&nbsp;&nbsp;&nbsp;注</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input " name="beizhu" lay-verify="title" autocomplete="off" placeholder="备注"> 
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="radio" class="field-status" name="status" value="0" title="启用">
                <input type="radio" class="field-status" name="status" value="1" title="禁用">
            </div>
        </div>
        <div class="layui-form-item">
