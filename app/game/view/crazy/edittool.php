<div class="layui-tab-item layui-show">
    ...
    <form class="layui-form layui-form-pane" action="{:url('editsave')}" id="editForm" method="post">
        <fieldset class="layui-elem-field layui-field-title">
          <legend>{$type}</legend>
        </fieldset>
        <input type="text" name="id" value="{$det.id}" hidden="hidden">
        <div class="layui-form-item">
            <label class="layui-form-label">道具名</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input field-username" value="{$det.name}" name="name" lay-verify="title" autocomplete="off" placeholder="请输入道具名">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline upload">
                ...
                <input type="hidden" class="upload-input" name="image" value="{$det.image}">
                <img src="{$det.image}" style="border-radius:5px;border:1px solid #ccc" width="36" height="36">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input " name="price" value="{$det.price}" lay-verify="title" autocomplete="off" placeholder="请输入价格">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">备&nbsp;&nbsp;&nbsp;&nbsp;注</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input " name="beizhu" value="{$det.beizhu}" lay-verify="title" autocomplete="off" placeholder="备注">
            </div>
        </div>
  <!--  <div class="layui-form-item">
