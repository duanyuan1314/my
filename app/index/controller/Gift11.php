...
class Gift extends Base
{
	...
	{	
		...
		$list = Db::name('GameGift')->where('status=1')->select();
	...
	*/
	...
	{	//$cardid
		...
		$cardet = Db::name('GameGift')->field('id,name,examout,image,url')->where('id',$id)->find();
	...
	public function confirmSave()
	{
		...
		if($this->request->isPost()){
			...
			$cardet = Db::name('GameGift')->field('id,name,examout,image,url')->where('id',$data['cardid'])->find();
