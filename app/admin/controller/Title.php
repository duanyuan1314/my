...
class Title extends Admin
{
    ...
    public function index($q = '')
    {
        ...
        $data_list = TitleModel::where($sqlmap)->paginate();
        //分页
    ...
    */
    public function titleedit($id)
    {
        ...
        $row = TitleModel::where('id', $id)->field('*')->find()->toArray();
