    ...
    <form class="layui-form layui-form-pane" action="{:url()}" id="editForm" method="post" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline upload">
                ...
                <img src="{$data_info['image']}" style="border-radius:5px;border:1px solid #ccc" width="70" height="35" >
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline upload ">
                <button type="button" name="upload" class="layui-btn layui-btn-primary layui-upload" lay-type="image" lay-data="{accept:'image'}">请上传图片</button>
                <input type="hidden" class="upload-input" name="icon" value="{$data_info['icon']}" >
                <img src="{$data_info['icon']}" style="border-radius:5px;border:1px solid #ccc" width="36" height="36">
            </div>
            <div class="layui-form-mid layui-word-aux"></div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input ctime"  value="{:date('Y-m-d', $data_info['ctime'])}" name="ctime" autocomplete="off" placeholder="请设置游戏上线时间" onclick="layui.laydate({elem: this,format:'YYYY-MM-DD'})" readonly>
            </div>
