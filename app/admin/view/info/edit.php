    ...
    <form class="layui-form layui-form-pane" action="{:url()}" id="editForm" method="post">
        ...
        <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width:300px;"  >
                    <textarea rows="10" class="layui-textarea" name="description" autocomplete="off" placeholder="请填写描述" >{$data_info['description']}</textarea>
                </div>
        </div>
        <!--图片-->
        <div class="layui-form-item" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea id="UEditor1" name="content" lay-verify="required" >{$data_info['content']}</textarea>
            </div>
        </div>
       <div class="layui-form-item">
