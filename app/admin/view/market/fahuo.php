    ...
    <div class="layui-tab-item layui-show" style="margin-top:5%;" >
        <form class="layui-form layui-form-pane"  method="post" >
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" id="tracking"  autocomplete="off" lay-verify="required"  >
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">备注</label>
                <div class="layui-input-inline" style="width:60%;" >
                    <textarea rows="5" class="layui-textarea"  autocomplete="off" lay-verify="required"  ></textarea>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button type="button" class="layui-btn" lay-submit=""  >确认发货</button>
                </div>
            </div>
        </form>
    </div>
