                ...
                <li class="layui-nav-item {if condition="$kk eq 1"}layui-nav-itemed{/if}">
                    ...
                    <dl class="layui-nav-child">
                        {if condition="$vv['title'] eq '快捷菜单'"}
                            ...
                            <dd><a class="admin-nav-item" data-id="{$vvv['id']}" href="{:url($vvv['url'].'?'.$vvv['param'])}"><i class="{$vvv['icon']}"></i> {$vvv['title']}</a>
                                <!-- <i data-href="{:url('menu/del?ids='.$vvv['id'])}" class="layui-icon j-del-menu">&#xe640;</i> -->
                            </dd>
                            {/volist}
                        {else /}
                            {volist name="vv['childs']" id="vvv"}
