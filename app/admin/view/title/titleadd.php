    ...
    <form class="layui-form layui-form-pane" action="{:url()}" id="editForm" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="name" lay-verify="title" autocomplete="off" placeholder="请输入称号名">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">时长(天)</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="limittime" lay-verify="title" autocomplete="off" placeholder="如：30">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">经验倍数</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="beishu" lay-verify="title" autocomplete="off" placeholder="请输入经验倍数">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">原价(乐豆)</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="ledou" lay-verify="title" autocomplete="off" placeholder="请输入原价">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">奖励碎片</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="chip" lay-verify="title" autocomplete="off" placeholder="请输入奖励碎片" >
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">现价(乐豆)</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="trueledou" lay-verify="title" autocomplete="off" placeholder="请输入现价">
            </div>
        </div>
        <div class="layui-form-item">
