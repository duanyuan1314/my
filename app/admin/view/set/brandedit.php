    ...
    <form class="layui-form layui-form-pane" action="{:url()}" id="editForm" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input field-username" name="name" lay-verify="title" autocomplete="off" value="{$data_info['name']}" placeholder="请输入用户名">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline upload">
                ...
                <img src="{$data_info['image']}"  width="36" height="36">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input " value="{$data_info['sortid']}" name="sortid" lay-verify="title" autocomplete="off" placeholder="请输入排序ID">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">跳转路径</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input " value="{$data_info['url']}" name="url" lay-verify="title" autocomplete="off" placeholder="请输入URL">
            </div>
        </div>
