<div class="layui-tab-item layui-show">
    ...
    <form class="layui-form layui-form-pane" action="{:url('addsave')}" id="editForm" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input field-username" name="userid" lay-verify="title" autocomplete="off" placeholder="请输入用户ID">
            </div>
       ...
       <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input field-username" name="beizhu" lay-verify="title" autocomplete="off" placeholder="备注">
            </div>
           <!--  <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
        </div>
