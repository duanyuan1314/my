<div class="layui-tab-item layui-show">
    ...
    <form class="layui-form layui-form-pane" action="{:url()}" id="editForm" method="post">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">充值乐豆</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="ledou" lay-verify="title" autocomplete="off" placeholder="请输入乐豆">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="cash" lay-verify="title" autocomplete="off" placeholder="RMB">
            </div>
           <!--  <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="luckbean" lay-verify="title" autocomplete="off" placeholder="请输入算力">
            </div>
           <!--  <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="jifen" lay-verify="title" autocomplete="off" placeholder="请输入积分">
            </div>
           <!--  <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
        </div>
