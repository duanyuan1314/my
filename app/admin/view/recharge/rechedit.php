<div class="layui-tab-item layui-show">
    ...
    <form class="layui-form layui-form-pane" action="{:url()}" id="editForm" method="post">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">乐豆额度</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="ledou" value="{$data_info['ledou']}" lay-verify="title" autocomplete="off" placeholder="请输入乐豆">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="cash" value="{$data_info['cash']}" lay-verify="title" autocomplete="off" placeholder="RMB">
            </div>
           <!--  <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="luckbean" value="{$data_info['luckbean']}" lay-verify="title" autocomplete="off" placeholder="请输入算力">
            </div>
           <!--  <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="jifen" value="{$data_info['jifen']}" lay-verify="title" autocomplete="off" placeholder="请输入积分">
            </div>
           <!--  <div class="layui-form-mid layui-word-aux">表单操作提示</div> -->
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                ...
                <a href="{:url('brand')}" class="layui-btn layui-btn-primary ml10"><i class="aicon ai-fanhui"></i>返回</a>
            </div>
        </div>
    </form>
</div>
